'''
    for loop and if loop have no problem 
    while to be tested 
'''
...
def calAverage(queue):
    ...
    print()
    print(f"Average Completion Time of Processes is {averageCt}")
    print(f"Average Turn Around Time of Processes is {averageTat}")
    print(f"Average Waiting Time of Processes is {averageWt}")
